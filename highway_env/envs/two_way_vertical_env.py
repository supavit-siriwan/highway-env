...
class TwoWayVerticalEnv(AbstractEnv):
    ...
    def _make_road(self, length=800):
        ...
        # Lanes
        net.add_lane("a", "b", StraightLane([0, length], [0, 0],
                                            line_types=(LineType.CONTINUOUS_LINE, LineType.STRIPED)))
        net.add_lane("a", "b", StraightLane([StraightLane.DEFAULT_WIDTH, length], [StraightLane.DEFAULT_WIDTH, 0],
                                            line_types=(LineType.NONE, LineType.CONTINUOUS_LINE)))
        net.add_lane("b", "a", StraightLane([StraightLane.DEFAULT_WIDTH, 0], [StraightLane.DEFAULT_WIDTH, length],
        ...
        for i in range(self.config["vehicles_same"]):
            self.road.vehicles.append(
                vehicles_type(road,
                              ...
                              .position(40+40*i + 10*self.np_random.randn(), 0),
